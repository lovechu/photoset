...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "API Support",
            "email": "support@photoset.example.com"
        },
        "license": {
            "name": "MIT",
    ...
    "paths": {
        ...
        "/api/auth/bind-email": {
            "put": {
                ...
                "parameters": [
                    {
                        "description": "绑定邮箱请求参数，包含email和code",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "default": "login",
                        "description": "场景(login/register/forgot)",
                        "name": "action",
                        "in": "query"
                    }
                ],
        ...
        "/api/auth/request-deletion": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "注销请求 {password, reason}",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.RequestDeletionRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/auth/reset-password": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "重置密码请求参数，包含token和new_password",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/auth/verify-email-code": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "验证请求参数，包含email、code和purpose",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/collections": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "合集信息 {name, description, is_public}",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/collections/by-photoset/{photosetId}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/collections/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "更新信息 {name, description, is_public}",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/collections/{id}/items/batch": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "套图ID数组 {photoset_ids}",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/collections/{id}/items/{photosetId}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service.SaveDraftRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/community/points-mall/items": {
            "get": {
                "consumes": [
                    "application/json"
                ],
        ...
        "/api/community/posts": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "帖子内容 {title, content, category, post_type, topics}",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/community/posts/{id}/favorite": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/community/posts/{id}/favorite/check": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/community/posts/{id}/reply": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "回复内容 {content, parent_reply_id, mentioned_user_ids}",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/community/posts/{id}/report": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "举报原因 {reason: string}",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "default": "mixed",
                        "description": "推荐类型(mixed/hot/collaborative)",
                        "name": "type",
                        "in": "query"
                    },
                    {
        ...
        "/api/community/replies/{id}/report": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/community/topics/{name}/posts": {
            "get": {
        ...
        "/api/community/user/achievements": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/community/users/:id/achievements": {
            "get": {
                "consumes": [
                    "application/json"
                ],
        ...
        "/api/orders/{id}/pay": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "参数错误或支付失败",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
                    "503": {
                        "description": "支付宝支付未配置",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    }
        ...
        "/api/photosets": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "状态筛选(draft/published/pending)",
                        "name": "status",
                        "in": "query"
                    }
                ],
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/domain.PhotoSet"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/photosets/{id}/comments": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "评论内容 {content, image_url, parent_id}",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/photosets/{id}/comments/{commentId}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/photosets/{id}/comments/{commentId}/like": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/photosets/{id}/comments/{commentId}/replies": {
            "get": {
        ...
        "/api/photosets/{id}/reviews": {
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "default": "newest",
                        "description": "排序方式(newest/highest/lowest)",
                        "name": "sort_by",
                        "in": "query"
                    }
                ],
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "评价请求 {rating, tags, content, is_anonymous}",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/photosets/{id}/reviews/summary": {
            "get": {
        ...
        "/api/photosets/{id}/reviews/{reviewId}": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "更新请求 {rating, tags, content, is_anonymous}",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/photosets/{id}/share-link": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "分享来源(app/web/miniapp)，默认app",
                        "name": "source",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        "domain.Category": {
            ...
            "properties": {
                ...
                "name": {
                    "description": "显示名称，如 \"自然风光\"",
                    "type": "string"
                },
                "slug": {
                    "description": "URL标识，如 \"nature\"",
                    "type": "string"
                },
                "sort_order": {
                    "description": "排序权重，越大越前",
                    "type": "integer"
                },
                "updated_at": {
                    "type": "string"
        ...
        "domain.PhotoSet": {
            ...
            "properties": {
                ...
                "is_favorited": {
                    "description": "非数据库字段（忽略数据库的 photo_count 列，手动计算）",
                    "type": "boolean"
                },
                "is_free": {
                    "type": "integer"
        ...
        "domain.Post": {
            ...
            "properties": {
                ...
                "photoset_id": {
                    "description": "nullable, optional association with photoset",
                    "type": "integer"
                },
                "post_type": {
                    "type": "string"
                ...
                "replies": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.PostReply"
                    }
                },
                "reply_count": {
                    "type": "integer"
        ...
        "domain.PostReply": {
            ...
            "properties": {
                ...
                "parent_reply_id": {
                    "description": "nil means direct reply to post",
                    "type": "integer"
                },
                "post_id": {
                    "type": "integer"
        ...
        "handlers.CreateRequest": {
            ...
            "properties": {
                ...
                "photos": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.Photo"
                    }
                },
                "price": {
                    "type": "number"
        ...
        "handlers.RequestDeletionRequest": {
            "type": "object",
            "required": [
                "password"
            ],
        ...
        "service.SaveDraftRequest": {
            ...
            "properties": {
                ...
                "id": {
                    "description": "nil for create, non-nil for update",
                    "type": "integer"
                },
                "post_type": {
                    "type": "string"
    ...
    "tags": [
        {
            "description": "用户认证相关接口（注册、登录、密码重置等）",
            "name": "Auth"
        },
        {
            "description": "套图管理接口（CRUD、列表、详情、下载等）",
            "name": "PhotoSet"
        },
        {
            "description": "社区互动接口（帖子、回帖、点赞、收藏等）",
            "name": "Community"
        },
        {
            "description": "用户信息接口",
        ...
        {
            "description": "用户等级与积分接口",
            "name": "UserLevel"
        },
        {
            "description": "OAuth2 第三方授权接口",
            "name": "OAuth2"
        },
        {
            "description": "分享链接接口",
